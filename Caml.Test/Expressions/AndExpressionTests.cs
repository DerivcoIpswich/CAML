...
namespace Caml.Expressions
{
    public class AndExpressionTests
    {
        public class IsMatch
        {
            ...
            public void returns_false_if_either_operand_is_false(bool leftReturns, bool rightReturns)
            {
                //Arrange
                var matcher = Mock.Of<IMatcher>();
            ...
            public void evaluation_is_conditional()
            {
                //Arrange
                var matcher = Mock.Of<IMatcher>();
                var leftMock = MockExpression(false);
                var rightMock = MockExpression(false);
            ...
            private static AndExpression BuildSubject(bool leftReturns, bool rightReturns)
            {
            ...
            private static AndExpression BuildSubject(Mock<IExpression> leftMock, Mock<IExpression> rightMock)
            {
                var symbol = Mock.Of<BinaryOperation>();
                return new AndExpression(symbol, leftMock.Object, rightMock.Object);
            }
        ...
        new public class ToString
        {
            ...
            public void returns_string_from_symbol()
            {
                ...
                var subject = new AndExpression(symbol.Object, null, null);
